...
def setRules (skor_FM, skor_FA, skor_FK):
    ...
    if alpha30 != 0:
        ...
        z30 = zr.z_high(alpha30)
        z_rule.append(z30)
        az30 = round((alpha30 * z30), 3)
        alpha_z.append(az30)
    
    #RULE 31: MODERATE - VERY HIGH - HIGH = HIGH
    ...
    if alpha31 != 0:
        ...
        z31 = zr.z_high(alpha31)
        z_rule.append(z31)
        az31 = round((alpha31 * z31), 3)
        alpha_z.append(az31)
    
    #RULE 32: MODERATE - VERY HIGH - VERY HIGH =  VERY HIGH
    ...
    if alpha54 != 0:
        ...
        z54 = zr.z_very_high(alpha54)
        z_rule.append(z54)
        az54 = round((alpha54 * z54), 3)
        alpha_z.append(az54)
    
    #RULE 55: VERY HIGH - MODERATE - HIGH = VERY HIGH
    ...
    #RULE 61: VERY HIGH - VERY HIGH - LOW = VERY HIGH  
    ...
    if alpha61 != 0:
        ...
        z61 = zr.z_very_high(alpha61)
        z_rule.append(z61)
        az61 = round((alpha61 * z61), 3)
        alpha_z.append(az61)
        
    #RULE 62:  VERY HIGH - VERY HIGH - MODERATE = VERY HIGH
